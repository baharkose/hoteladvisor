...
const Switch = () => {
  const [darkMode, setDarkMode] = useState(
    ...
    //- başlangıçda dark modu false yap yoksa localden al
  );

  if (darkMode) {
    document.documentElement.classList.add("dark");
    localStorage.setItem("darkMode", true);
    //- dark mode true ise classliste darkı ekle.
    //- local stografe e true değerini ekle
  } else {
    document.documentElement.classList.remove("dark");
    localStorage.removeItem("darkMode");
    //- değilse localden ve classlistten darkmodu kaldır.
    
  }

  //- butona her tıklandığında dark mode değişsin
